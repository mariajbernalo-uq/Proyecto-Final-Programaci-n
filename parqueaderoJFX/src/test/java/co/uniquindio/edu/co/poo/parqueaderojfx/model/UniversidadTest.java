...
class UniversidadTest {
    ...
    void calcularTiempoPermanenciaTest() {
        ...
        Vehiculo vehiculo=new Vehiculo("mq","Sofia",147,"2026-05-24 08:00","2026-05-24 12:00",null, CARRO,null,EstadoVehiculo.DENTRO);
        assertEquals(4.0,universidad.calcularTiempoPermanencia(vehiculo.getHoraIngreso(), vehiculo.getHoraSalida()));
    }
    @Test
    void registrarSalidaVehiculoTest() {
        ...
        void consultarVehiculosEstacionadosTest () {
            ...
            Vehiculo vehiculo1 = new Vehiculo("mq12", "Sofia", 152, "2026-05-24 08:00", null, espacioParqueadero12, CARRO, null, EstadoVehiculo.DENTRO);
            Vehiculo vehiculo2 = new Vehiculo("mq13", "Majo", 185, "2026-05-24 10:00", null, espacioParqueadero13, TipoVehiculo.MOTOCICLETA, null, EstadoVehiculo.DENTRO);
            ...
            assertEquals("=== VEHICULOS ACTUALMENTE ESTACIONADOS ===\n" +
                    "Placa: mq12 | Tipo: CARRO | Hora ingreso: 2026-05-24 08:00 | Espacio: 526\n" +
                    "Placa: mq13 | Tipo: MOTOCICLETA | Hora ingreso: 2026-05-24 10:00 | Espacio: 521\n", universidad.consultarVehiculosEstacionados());
        }
        @Test
        ...
        void generarFacturaTest () {
            ...
            Tarifa tarifa = new Tarifa(CARRO);
            Vehiculo vehiculo1 = new Vehiculo("mq12", "Sofia", 152, "2026-05-24 08:00", "2026-05-24 12:00", espacioParqueadero14, CARRO, usuario, EstadoVehiculo.DENTRO);
            universidad.getListVehiculos().add(vehiculo1);
            String resultado = universidad.generarFactura("mq12", "2026-05-24 12:00");
    ...
    void generarReporteTest() {
        Universidad universidad = new Universidad("uq", 159, "34");
        EspacioParqueadero espacio1 = new EspacioParqueadero(520, TipoVehiculo.CARRO);
        EspacioParqueadero espacio2 = new EspacioParqueadero(519, TipoVehiculo.MOTOCICLETA);
        Usuario usuario = new Usuario("Majo", "185", TipoUsuario.VISITANTE);
        String fechaHoy = LocalDate.now().toString();
        Vehiculo vehiculoDentro = new Vehiculo("mq12", "Sofia", 152, fechaHoy + " 08:00", null, espacio1, TipoVehiculo.CARRO, usuario, EstadoVehiculo.DENTRO);
        Vehiculo vehiculoFuera = new Vehiculo("mq13", "Majo", 185, fechaHoy + " 10:00", fechaHoy + " 12:00", espacio2, TipoVehiculo.MOTOCICLETA, usuario, EstadoVehiculo.FUERA);
        espacio1.setEstadoEspacio(EstadoEspacio.OCUPADO);
        espacio2.setEstadoEspacio(EstadoEspacio.OCUPADO);
        universidad.getListVehiculos().add(vehiculoDentro);
        universidad.getListVehiculos().add(vehiculoFuera);
        universidad.getListEspaciosParqueaderos().add(espacio1);
        universidad.getListEspaciosParqueaderos().add(espacio2);
        Tarifa tarifaCarro = new Tarifa(TipoVehiculo.CARRO);
        Tarifa tarifaMoto = new Tarifa(TipoVehiculo.MOTOCICLETA);
        universidad.getListTarifas().add(tarifaCarro);
        universidad.getListTarifas().add(tarifaMoto);
        String reporte = universidad.generarReporte();
        assertTrue(reporte.contains("Total vehículos registrados: 2"));
        assertTrue(reporte.contains("Vehículos dentro: 1"));
        assertTrue(reporte.contains("Vehículos fuera: 1"));
        assertTrue(reporte.contains("Espacios totales: 2"));
        assertTrue(reporte.contains("Espacios disponibles: 0"));
        assertTrue(reporte.contains("Ingresos generados hoy: $"));
        assertTrue(reporte.contains("Tiempo promedio de permanencia hoy:"));
        assertTrue(reporte.contains("Vehículos que permanecieron más de 4 horas:"));
    }
        @Test
        ...
        void tiempoPromedioPermanenciaTest () {
            ...
            Vehiculo vehiculo1 = new Vehiculo("mq12", "Sofia", 152, "2026-05-24 08:00", "2026-05-24 12:00", espacioParqueadero1, CARRO, null, EstadoVehiculo.DENTRO);
            ...
            universidad.getListVehiculos().add(vehiculo1);
            universidad.getListVehiculos().add(vehiculo2);
            assertEquals(3.0, universidad.tiempoPromedioPermanencia());
        }
